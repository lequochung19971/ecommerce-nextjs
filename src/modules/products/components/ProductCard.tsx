...
export function ProductCard() {
  return (
    <Flex p={50} w="full" alignItems="center" justifyContent="center" width="350px">
      <Card bg={useColorModeValue('white', 'gray.800')} maxW="sm" shadow="lg" position="relative">
        <Image src={data.imageURL} alt={`Picture of ${data.name}`} roundedTop="md" />
